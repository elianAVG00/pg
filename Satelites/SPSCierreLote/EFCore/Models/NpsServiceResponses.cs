...
public partial class NpsServiceResponses
{
    ...
    public virtual ICollection<NpsServiceResponseQueryTrxs> NpsServiceResponseQueryTrxs { get; set; } = new List<NpsServiceResponseQueryTrxs>();

    public virtual NpsServiceRequests? SvcReq { get; set; }
}
