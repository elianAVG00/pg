...
namespace PGSyncro.Utils
{
    static public class MailerService
    {
        ...
        public static bool SendEmail(MailerModel basicMail)
        {
            ...
            {
             //   Logger.InsertException("SendEmail l50", ex);
                return false;
            }
        }
        ...
        private static bool SendEmail(MailAddress from, MailAddressCollection toList, MailAddressCollection ccList, MailAddressCollection bcList, String subject, String body, List<FileAttachment> attachments, Boolean isBodyHtml, MailPriority mailPriority)
        {
            ...
            {
              //  Logger.InsertException("SendEmail l97", ex);
            }
        ...
        private static bool SendEmail(MailMessage mailMessage)
        {
            try
            {
               ...
               // Logger.InsertLog("Debug", "SendMail", "Correo enviado");
                return true;
            ...
            catch (SmtpFailedRecipientException ex)
            {
             ...
             //   Logger.InsertException("SendEmail l133", ex);

            }
            catch (SmtpException ex)
            {

             //   Logger.InsertException("SendEmail l139", ex);

            }
            catch (ArgumentException ex)
            {

            //    Logger.InsertException("SendEmail l145", ex);

            }
            catch (ObjectDisposedException ex)
            {

             //   Logger.InsertException("SendEmail l151", ex);

            }
            catch (InvalidOperationException ex)
            {

            //    Logger.InsertException("SendEmail l157", ex);

            }
            catch (Exception ex)
            {

              //  Logger.InsertException("SendEmail l163", ex);
            }
